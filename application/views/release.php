		...
		<div class="content">
			...
			<div class="animated fadeIn">
				...
				<div class="card text-left">
					...
					<div class="card-body">
						<table class="table table-bordered table-sm" id="release_table">
							<thead>
								<tr>
							...
							<tbody>
								<?php foreach($release as $key => $request){ ?>
								<tr>
									<td><?php echo $request['requesting_office'];?></td>
									<td><?php echo $request['release_date'] == NULL ? '' :  date('F m, Y h:i a', strtotime($request['release_date']));?></td>
									<td>
										<ul class="nav navbar-right panel_toolbox">
											<li class="dropdown">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-cog"></i></a>
												<div class="dropdown-menu" aria-labelledby="dropdownMenuButton""> 
                          <a href=" <?php echo base_url().'release/view_release/'. $request['request_id'] ?>" class="dropdown-item text-primary" title="View Request"><i class="fa fa-eye"></i> View</a>
