...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<div class="content">
			...
			<div class="animated fadeIn">
				...
				<!-- /#event-modal -->
				<div class="card">
					<form class="form-horizontal" action="<?php echo base_url();?>delivery/submit_delivery_item" method="POST">
						<div class="card-body">
                      ...
                      <table class="table-borderless">
                        <tr>
                          ...
                          foreach($items as $key => $item){                ?>
												<option data-item-size="<?php echo $item['size']; ?>" data-item-unit="<?php echo $item['unit']; ?>" data-stock-quantity="<?php echo $item['quantity']; ?>" value="<?php echo $item['item_no']?>"><?php echo $item['description']  ?></option>
												<?php } } ?> 
											</select>
										</td>
										<td><input readonly class="form-control size" name="size[]" type="text" placeholder="Size"></td>
										<td><input readonly class="form-control unit" name="unit[]" type="text" placeholder="Units"></td>
										<td>
											<input type="text" class="stock_quantity form-control"  name="limit_quantity[]" readonly placeholder="Stock">
										</td>
										<td><input min="1" type="number" class="form-control" name="quantity[]" required="" placeholder="Quantity"> </td>
										<td>
											<select data-row="row_id_1" class="form-control"  name="category_id[]">
	...
	<script>
      ...
      if(btn == '1'){
        ...
        html_code += '<td><input readonly class="form-control size" name="size[]" type="text" placeholder="Size"></td>';
        html_code += '<td><input readonly class="form-control unit" name="unit[]" type="text" placeholder="Units"></td>';
        html_code += '<td><input type="text" class="stock_quantity form-control" name="limit_quantity[]" readonly placeholder="Stock"> </td>';
        ...
        html_code += '<td><input type="text" name="item[]" class="form-control" placeholder="Enter Item"></td>';
        ...
        html_code += '<td><input type="text" name="limit_quantity[]" class="form-control" placeholder="Enter Limits"></td>';
        html_code += '<td><input type="text" name="quantity[]" class="form-control" placeholder="Enter Quantity"></td>';
        html_code += `<td>
                        <select  data-row="row_id_` + count + `"  name="category_id[]" class="form-control category ">
                          <option value="">Choose Category</option>
                        <?php if(!empty($category)){ 
