			...
			<div class="animated fadeIn">
				...
				<div class="card text-left">
                    ...
                    $i = 1;  ?>
								...
								<form method="POST" action="<?php echo base_url().'request/released_request/'.$request['request_id'];?>">
								<div class="row justify-content-start mt-5">
									
									<div class="col-6">
										<div class="form-group">
											<label for="">Approved:</label>
											<input name="approved_by" value="<?php echo $request['approved_by'];  ?>" class="form-control released_input" type="text" required="" placeholder="Enter name">
								...
								<div class="row justify-content-end ">
									<div class="col-6">
										<div class="form-group">
											...
											<input name="released_by" value="<?php echo $request['released_by'];  ?>" class="form-control released_input " type="text" required="" placeholder="Enter name">
											<div class="text-center">
								...
								<div class="row">
									<div class="col-6">
										<div class="form-group">
											...
											<input name="received_by" value="<?php echo $request['received_by'];  ?>" class="form-control released_input" type="text" required="" placeholder="Enter name">
											<div class="text-center">
												<span><small><i>Signature over Printed Name</small></i></span>
											</div>
										</div>
									...
									<div class="col-6">
										<div class="form-group">
											...
											<input name="date_recieved" value="<?php echo date('Y-m-d', strtotime($request['received_date']));  ?>" class="form-control released_input text-center" type="date" required="" placeholder="Enter name">
										</div>
									</div>
								</div>
