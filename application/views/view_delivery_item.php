		...
		<div class="content">
			...
			<div class="animated fadeIn">
				...
				<div class="card text-left">
							...
							<div class="col-10">
								<div class="row mb-4 mt-3">
									...
									<div class="col-4 mt-3">
										<div class="text-center pl-0">
											<h5 class="font-weight-bold" style="color:darkblue;">DELIVERY ITEMS</h5>
								...
								<table class="table table-borderless table-sm table-responsive">
									<tr>
										...
										<td class="font-weight-bold text-capitalize"><?php echo $this->session->userdata('name'); ?></td>
									</tr>
									<tr>
										<td scope="row">Date Added:</td>
										<td class="font-weight-bold text-capitalize"><?php echo date('F d, Y h:i:s A', strtotime($delivery['delivery_date']))?></td>
									</tr>
								</table>
								<hr>
                    ...
                    $i = 1;  ?>
										<?php foreach($delivery_items as $key => $delivery_item){ ?>
										<tr>
											<td><?php echo $i; ?></td>
											<td><?php echo $delivery_item['description'];?></td>
											<td><?php echo $delivery_item['size'];?></td> 
											<td><?php echo $delivery_item['qty'];?></td>
											<td><?php echo $delivery_item['unit'];?></td> 
										</tr>
										<?php $i++; } } ?>
									</tbody>
								</table>
